            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group">
                  <input type="text" className="form-control text-white mb-3" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} required />
                </div>
                <div className="form-group">
              ...
              <div className="text-center mt-3">
                <p className='text-white' >Already an existing user? <a href="/login" className="text-primary">Login here</a>.</p>
              </div>
            </div>
          </div>
        </div>
